...
sjp.glm(glm7a, type = "pred", vars = c("Polychaeta", "Sediment"), show.ci = TRUE, facet.grid = FALSE)
...
En este caso la presencia de los Polychaeta es significativa y las algas seleccionadas (dos especies) son mucho mas importantes en la relacion. Al final el modelo podria ser logistico pero al ser de presencia ausencia, la interpretacion es mas dificil que con variables continuas.
